...
export default {
  ...
  head () {
    const origin = process.client ? location.origin : 'sad'
    return {
      meta: [
        // Open Graph
        ...
        { property: 'og:image', content: origin + '/images/logo_img.png' },
        ...
        { property: 'twitter:image', content: origin + '/images/logo_img.png' },
